...
Сервис для получения актуальной информации о стране.
...
Клонируйте репозиторий проекта в свою рабочую директорию:
    ...
    .. code-block:: console
        git clone https://github.com/StinkyPeterson/python-course-portfolio.git


Использование
=============

1. Чтобы управлять вашим API, необходимо запустить сервисы с помощью команд:

    .. code-block:: console
        docker-compose up

2. Сервис доступен по адресу http://0.0.0.0:8020
